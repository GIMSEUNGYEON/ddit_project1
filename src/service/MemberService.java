...
public class MemberService {
	...
	public int signUp() {
		...
		String hp="";
		  while (true) {
			  System.out.println(" ¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡");
		         System.out.println(" * ÀüÈ­¹øÈ£ ÀÔ·Â [-Á¦¿Ü 11ÀÚ¸®·Î ÀÔ·ÂÇØÁÖ¼¼¿ä.]");
		         System.out.print(" >> ");
...
//			return 
			...
			if(makepw.equals(make)) {
				...
				return View.MEMBER_LOGIN;
					...
					System.out.println("°ü¸®ÀÚ »ý¼º ºñ¹Ð¹øÈ£°¡ Æ²·È½À´Ï´Ù. ¸ÞÀÎ È­¸éÀ¸·Î ÀÌµ¿ÇÕ´Ï´Ù.");
					ScanUtil.nextLine();
			}
...
// ÀÌ¸§ Á¤±ÔÈ­ true : Á¤±ÔÈ­ ¿Ï | false : ´Ù½Ã ÀÔ·Â
	...
	public int inquiry() {
        ...
        System.out.println("¾ÆÀÌµð :\t" + list.get("¾ÆÀÌµð"));
        System.out.println("ÀÌ¸§ :\t" + list.get("ÀÌ¸§"));
        System.out.println("ÀüÈ­¹øÈ£ :\t" + list.get("ÀüÈ­¹øÈ£"));
     }
	...
	public int infoUpdate() {
		...
		printUtil.bar();
		System.out.println( "º»ÀÎ È®ÀÎÀ» À§ÇØ ºñ¹Ð¹øÈ£¸¦ ÀÔ·ÂÇØÁÖ¼¼¿ä.");
		 System.out.print("¹øÈ£ÀÔ·Â>> ");
		...
		if(result2>0) {
			...
			System.out.println("ºñ¹Ð¹øÈ£°¡ ÀÏÄ¡ÇÏÁö ¾Ê½À´Ï´Ù. È¨È­¸éÀ¸·Î µ¹¾Æ°©´Ï´Ù.");
			ScanUtil.nextLine();
		}
		return View.HOME;
	...
	public int withdraw() {
	      ...
	      if(pw.equals(memPW)) {
				...
				System.out.println("Á¤¸» Å»ÅðÇÏ½Ã°Ú½À´Ï±î? (y/n)");
				String flag=ScanUtil.nextLine();
				if(flag.equalsIgnoreCase("y")) {
...
//		System.out.println(result);
		...
		if(result>0) {
			System.out.println("ÁÂ¼®À» ÀÌ¿ëÁßÀÔ´Ï´Ù.Åð½Ç ÈÄ ÀÌ¿ëÇØÁÖ½Ê½Ã¿À.");
			ScanUtil.nextLine();
			return View.RESERVATION;
		     ...
		     // È¸¿ø Á¤º¸ »èÁ¦
		        ...
		        if (result4 > 0) {
		        	System.out.println();
		            System.out.println("*Å»Åð°¡ ¿Ï·áµÇ¾ú½À´Ï´Ù. ÀÌ¿ëÇØ ÁÖ¼Å¼­ °¨»çÇÕ´Ï´Ù.*");
		            ScanUtil.nextLine();            
		            Controller.sessionStorage.put("login", false);
		            Controller.sessionStorage.put("loginInfo", null);
		            return View.MAIN;
		        } else {
		            System.out.println("Å»Åð Áß ¹®Á¦°¡ ¹ß»ýÇß½À´Ï´Ù. ´Ù½Ã ½ÃµµÇØÁÖ¼¼¿ä.");
		            ScanUtil.nextLine(); 
	...
	public int admin_inquiry() {
		...
		printUtil.blank(1);
		System.out.println(" 1.È¸¿øÁ¤º¸¼öÁ¤  2.È¸¿øÅ»Åð   3.È¸¿ø¸ñ·Ï Á¶È¸   0.µÚ·Î°¡±â");
		printUtil.bar();
		System.out.print("¹øÈ£ÀÔ·Â>> ");
		int select = ScanUtil.nextInt();
	...
	public int MemberList() {
		...
		if(map!=null) {
		String sql="SELECT MEM_ID ¾ÆÀÌµð, MEM_NAME ÀÌ¸§, MEM_HP ÀüÈ­¹øÈ£ FROM MEMBER WHERE MEM_ID != 'guest' ORDER BY MEM_NAME ASC";
	        ...
	        List<Map<String, Object>> memberList=memberDao.adminInquiry(sql);
	        	...
	        	for (Map<String, Object> list : memberList) {
		        System.out.print("¾ÆÀÌµð : "+list.get("¾ÆÀÌµð") + "\t");
		        System.out.print("ÀÌ¸§ : " + list.get("ÀÌ¸§") + "   ");
		        System.out.println("ÀüÈ­¹øÈ£ : " + list.get("ÀüÈ­¹øÈ£")+ "\t");
		}
	}
		printUtil.bar2();
